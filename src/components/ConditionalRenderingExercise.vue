    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="border p-1">
          ...
          <div v-if="state.grade.assignment1 >= 90">
            <p>The grade is 'A'.</p>
          </div>
          <!-- v-else-if comparing grade and 80 -->
          <div
            v-if="
              (state.grade.assignment1 >= 80) & (state.grade.assignment1 < 90)
            "
          >
            <p>The grade is 'B'.</p>
          </div>
          ...
          <div
            v-if="
              (state.grade.assignment1 >= 70) & (state.grade.assignment1 < 80)
            "
          >
            <p>The grade is 'C'.</p>
          </div>
          ...
          <div
            v-if="
              (state.grade.assignment1 >= 60) & (state.grade.assignment1 < 70)
            "
          >
            <p>The grade is 'D'.</p>
          </div>
          <!-- v-else to display if all the others fail -->
          <div v-if="state.grade.assignment1 < 60">
            <p>The grade is 'F'.</p>
          </div>
        </div>
        <div class="border p-1">
          ...
          <div class="player-card text-center area">
            <div>
              <img :src="state.player.photo" />
            </div>
            <div>
